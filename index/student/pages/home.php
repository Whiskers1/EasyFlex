...
<div id="content" class="flex-fill" style="width: 100%; padding: 50px 50px;">
    ...
    <div class="row">
        <div class="col-md-8 blog-main">
            ...
            <div class="blog-post">
                <h2 class="blog-post-title">EMMA</h2>
                <p class="blog-post-meta">December 23, 2013</p>

                <p>Som skp elev der søges 1 elevstilling + alt hvad der er på <a href="www.praktikpladsen.dk">praktikpladsen</a>hver uge og til <a href="eod_skp_elevansog@sde.dk">eod_skp_ elevansog@sde.dk</a></p>
                <blockquote>
                    <p>Curabitur <strong>Nullam</strong> elit.*</p>
                </blockquote>
                <p>Etiam <em>malesuada</em> consectetur.*</p>
                <p>Vivamus.*</p>
            </div><!-- /.blog-post -->
